...
questions = Question.create([
  {title:"Extremist organizations and funding", body:"How does Somali extremist organization al-Shabaab get its funding?"},
  {title:"ISIS and civilians", body:"What threat does ISIS pose to civilians? "},
  {title:"Counterinsurgency plans", body:"Does the US have effective counterinsurgency strategy?"},
  {title:"Single-payer health care", body:"Should the US adopt European-style single-payer health care?"},
  {title:"ISI and Latin America", body:"Can someone quickly explain Import-Substitution-Industrialization? Was it good for Latin America?"},
  {title:"Economic Theory", body:"(follow up) What is a better theory for economic development?"}
...
responses = Response.create([
  ...
  Report of the UN Somalia and Eritrea Monitoring Group, Somalia (UN document S/2013/413, 13 October 2013), p. 413"},

  {body:"ISIS poses a serious genocidal threat to civilians. The UN reports that ISIS routinely kills members of the Yazidi ethnic group and dumps the bodies in mass graves (http://www.un.org/apps/news/story.asp?NewsID=50369#.VRG_zBDF_bw). Philosophically, ISIS is also willing to kill any person who does not worship conservative Salafi Sunni Islam, which poses an enormous threat to hundreds millions of Shia muslims living in the region (Weiss and Hassan, ISIS, Inside the Army of Terror). Graeme Wood explains further in The Atlantic,
  ...
  Furthermore, if the US were to switch to a single-payer system, US doctors offices and hospitals would no longer turn away the ill. In turn, this would encourage the sick to seek primary medical care before illnesses or injuries became life-threatening, which would save the US money. Primary care is significantly less expensive compared to emergency medical care."},

  {body:"Import-Substitution-Industrialization (ISI) was widely used in the 1980’s to spur domestic economic production and foster local industries. Instead of importing basic products, LatAm countries would import raw materials and then manufacture finished goods locally. This allowed fledgling LatAm manufacturers to begin production without international competition. There was no way for a startup shoe company, for example, to compete with Nike or Adidas in the ‘80s, so ISI policies created jobs and growth.

  However, the protectionist policies meant that ISI companies never competed internationally. There was no incentive for local manufacturers to become competitive. Bosses would make strong profits with protectionist policies in their own countries. Competing on the world market, while beneficial to consumers, was not conducive to the bottom line of fledgling manufactures. As a result, these small producers never became globally competitive."},

  {body:"Around the same time, numerous Asian states began export-led growth policies that encouraged all producers to send products onto the world market. This competition fostered better companies and better ideas in Asia. The states would subsidize the countries to help pay for the upfront costs of becoming a world producer, after which these producers would be able to compete worldwide, creating jobs back home."}
